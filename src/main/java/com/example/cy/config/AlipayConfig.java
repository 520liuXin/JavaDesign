package com.example.cy.config;
    ...
    public class AlipayConfig {
        ...
        public static String notify_url = "http://127.0.0.1:8888/car/findByVogue";

        //Controller Mapping:得放到服务器上，且使用域名解析 IP
        public static String return_url = "http://127.0.0.1:8888/car/findByVogue";
        ...
        public static String public_key = "";
