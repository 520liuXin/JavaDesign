$(function(){
    ...
    var loadCharts1Data = function(data){
      var json = {};
      json.chart = {
        type:"column"
      };
      ...
      $(".chartsContainer1").highcharts(json);
    }
    var loadCharts2Data = function(data){
      var json = {};
      json.chart = {
        type:"bar"
      };
    ...
    var loadCharts3Data = function(data){
      var json = {};
      json.chart = {
        type: 'spline',
     ...
     $('.chartsContainer3').highcharts(json);
    }
    var loadCharts4Data = function(data){
      var json = {};
      json.chart = {
        type: 'scatter',
        zoomType: 'xy'
     ...
     $(".chartsContainer4").highcharts(json);
    }
